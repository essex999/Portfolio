...
export const aboutMeTextContent = [
	'Hi , i am Octavian , year and a half ago, i embarked on my journey into web development by enrolling in Skypro school. Since then, I’ve been actively expanding my knowledge, self-learning various technologies.<br> My toolkit includes HTML, CSS, SCSS, JavaScript, along with libraries and frameworks such as React.js, Axios, Redux, and React Query. <br>I have experience in developing single-page applications, available on my GitHub page. Additionally, I’ve worked with databases, creating them using Node.js, Express.js, and MongoDB.<br> I’m passionately dedicated to crafting high-quality web projects and continuously strive to enhance my skills. ',
]
